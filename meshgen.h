...
typedef struct { int vid[4]; char BC[4][4];} quad;
typedef struct { int vid[8];} hex;
typedef struct { point vert[8]; int btid; int elid[2]; int nbid[8]; char BC[8][3];} block;

int make_quad_space(int,int,point*,char[4][4]);
int make_gquad_space(int,int,double,point*,char[4][4]);
int make_g2quad_space(int,int,double,double,point*,char[4][4]);
int make_cquad_space(int,int,double,double,double,point*,char[4][4]);

int make_tri_space(int,double*,double*);
